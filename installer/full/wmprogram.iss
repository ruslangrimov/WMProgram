...
AppId={{23C455C9-B046-420A-B27F-23E73A26E6EA}
AppName=WMProgram
AppVerName=WMProgram 1.0
...
[Icons]
Name: "{group}\WMProgram"; Filename: "{app}\WMProgram.exe"
Name: "{group}\{cm:ProgramOnTheWeb,WM Program}"; Filename: "http://www.wmprogram.ru/"
Name: "{group}\Справка"; Filename: "{app}\wmhelp.chm"
Name: "{group}\{cm:UninstallProgram,WMProgram}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\WMProgram"; Filename: "{app}\WMProgram.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\WMProgram"; Filename: "{app}\WMProgram.exe"; Tasks: quicklaunchicon

[Run]
Filename: "{app}\WMProgram.exe"; Description: "{cm:LaunchProgram,WMProgram}"; Flags: nowait postinstall skipifsilent
